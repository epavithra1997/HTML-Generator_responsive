...
public class MainActivity {
                ...
                static int valX = 0;
                static int valY = 0;
                static Map<String, Layers> decoded; 
                private static Scanner sc;
                static FileWriter htmlWriter;
                static FileWriter cssWriter;
                static BufferedWriter htmlBuffer;
                static BufferedWriter cssBuffer;
                ...
                public static void main(String[] args) throws FileNotFoundException {
                                ...
                                try {
                                                ...
                                                if (htmlFile.createNewFile() && cssFile.createNewFile() ) {
                                                    ...
                                                    htmlBuffer = new BufferedWriter(htmlWriter);
                                                    cssBuffer = new BufferedWriter(cssWriter);
                                                               ...
                                                               // System.out.println(":jjjj");
                                                                for(i=1;i<=2;i++)
                                                                {
                                                                	if(i==1)
                                                                	{
                                                                		String path = "C:\\Users\\765749\\Documents\\desktopJSON1.json";
                                                                		BufferedReader br = new BufferedReader(new FileReader(path));
                                                                		decoded= gson.fromJson(br, new TypeToken<Map<String, Layers>>() {
                                                                        }.getType());
                                                                		cssContent =cssContent + "@media only screen and (min-width:1000px){";
                                                                	...
                                                                	{
                                                                		String path = "C:\\Users\\765749\\Documents\\mobileJSON.json";
                                                                		BufferedReader br = new BufferedReader(new FileReader(path));
                                                                		decoded= gson.fromJson(br, new TypeToken<Map<String, Layers>>() {
                                                                        }.getType());
                                                                		cssContent =cssContent + "@media only screen and (max-width:1000px){";
                                                                		callingHTML(decoded);
                                                                		callingCSS(decoded);
                                                                		cssContent=cssContent+"}";
                                                                	}
					...
					private static void callingCSS(Map<String, Layers> decoded2) {
				...
				private static void callingHTML(Map<String, Layers> decoded2) throws IOException {
